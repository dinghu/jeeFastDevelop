        ...
        <tr>
            ...
            <td>
                <${'@'}button type="purple" icon="fa fa-pencil"
                              onclick="XJJ.edit('${'$'}{base}${model.requestMapping?uncap_first}/input/${'$'}{item.id}','修改${model.label}','${'$'}{tabId}');">
                    修改
                </${'@'}button>
                <${'@'}button type="danger" icon=" fa fa-trash-o"
                              onclick="XJJ.del('${'$'}{base}${model.requestMapping?uncap_first}/delete/${'$'}{item.id}','删除${model.label}？',false,{id:'${'$'}{tabId}'});">
                    删除
                </${'@'}button>
            </td>
        </tr>
