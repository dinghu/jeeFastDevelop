...
package com.fast.develop.sec.entity;
...
public class RolePrivilegeEntity extends EntitySupport {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("RolePrivilegeEntity").append("ID="+this.getId()).toString();
    }
}
