            ...
            <div class="dataTables_paginate paging_simple_numbers"
                ...
                <ul class="pagination" style="margin:0;">
                    ...
                    <#if pagenum gt 1>
                        ...
                        <li <#if page.currentPage == 1>class="disabled"</#if>>
                            <a href="javascript:XJJ.page({id:'${id}',currentPage:${page.currentPage-1}});"
                               class="crud crudprev">
                        ...
                        <#if pagenum lte 3>
                            <#list 1..pagenum as pn>
                                <li <#if page.currentPage == pn>class="active"</#if>>
                                    <a href="javascript:XJJ.page({id:'${id}',currentPage:${pn}});"
                                       class="cruda">${pn}</a>
                                </li>
                            </#list>
                        </#if>
                        ...
                        <li <#if page.currentPage == pagenum>class="disabled"</#if>>
                            <a href="javascript:XJJ.page({id:'${id}',currentPage:${page.totalPage}});"
                               class="crud crudlast" data="page:${pagenum}">
