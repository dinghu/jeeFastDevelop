                    ...
                    <#list treeNode.nodes?sort_by('text') as treeNode1>
                        <tr>
                            <td>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="menu_${treeNode1.id}"
                                                               onclick="checkSelect('menu_${treeNode1.id}')">
                                ${treeNode1.text}
                            </td>
                        </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <#list treeNode1.nodes?sort_by('text') as treeNode2>
                                        <input type="hidden" name="menu_${treeNode1.id}"
                                               class="menu_${treeNode1.id}_${treeNode2.id}"
                                               value="${treeNode2.checked}"/>
                                        &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox"
                                                                       id="menu_${treeNode1.id}_${treeNode2.id}"
                                                                       name="codes" class="menu_${treeNode1.id}"
                                                                       value="${treeNode2.id}"
                                                                       onclick="checkSelect1('menu_${treeNode1.id}','${treeNode2.id}')">
                                        ${treeNode2.text}
                                    </#list>
                                </td>
                            </tr>
