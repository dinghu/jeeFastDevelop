...
<#--查询区-->
    <@query queryUrl="${base}/sec/user/list" id=tabId>
        ...
        <@querygroup title='账号'>
            <input type="search" name="query.loginName@lk@s" class="form-control input-sm" placeholder="请输入账号"
                   aria-controls="dynamic-table">
        </@querygroup>
        <@querygroup title='姓名'>
            <input type="search" name="query.userName@lk@s" class="form-control input-sm" placeholder="请输入姓名"
                   aria-controls="dynamic-table">
        </@querygroup>

        <@querygroup title='手机'>
            <input type="search" name="query.mobile@eq@s" class="form-control input-sm" placeholder="请输入手机号"
                   aria-controls="dynamic-table">
        </@querygroup>
        <@querygroup title='邮箱'>
            <input type="search" name="query.email@eq@s" class="form-control input-sm" placeholder="请输入邮箱"
                   aria-controls="dynamic-table">
        </@querygroup>
        <@querygroup title='状态'>
        ...
        <@querygroup title='生日'>
            <input type="search" name="query.birthday@ge@D" class="date form-control date-picker input-sm" type="text"
                   placeholder="请选择开始日期">
        </@querygroup>
        <@querygroup title='生日'>
            <input type="search" name="query.birthday@le@D" class="date form-control date-picker input-sm" type="text"
                   placeholder="请选择结束日期">
        </@querygroup>
