...
<table class='table table-responsive'>
    ...
    <#list menuList as m>
        <tr>
            <td>
                <#if m.subMenus?? && m.subMenus?size gt 0><a href="javascript:void(0)"
                                                             onclick="javascript:toggle(${m.id},this)" id="a${m.id}">
                        <span class="glyphicon glyphicon-minus"></span></a></#if>
        ...
        <#if m.subMenus?? && m.subMenus?size gt 0>
            <#list m.subMenus as mm>
                <tr class="${m.id}">
                    <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<#if mm.subMenus?? && mm.subMenus?size gt 0><a
                        href="javascript:void(0)" onclick="javascript:toggle(${mm.id},this)" id="a${mm.id}"><span
                                    class="glyphicon glyphicon-minus"></span></a></#if>${mm.title}</td>
